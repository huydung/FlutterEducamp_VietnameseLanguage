...
import 'package:Vietnamese_and_Flutter_Educamp/pages/e6_CoupleMatchScoreResult.dart';
...
class E6_CoupleMatchState extends State<E6_CoupleMatch> {
  ...
  Widget build(BuildContext context) {
    ...
    BirthYearSelectionWidget p1BirthYearSelectionWidget = BirthYearSelectionWidget(
      gender: Gender.MALE,
      birthYear: DateTime.now().year.toDouble() - 45 + (Random().nextInt(30)),

    );
    BirthYearSelectionWidget p2BirthYearSelectionWidget = BirthYearSelectionWidget(
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children: [
          ...
          Expanded(
            flex: 3,
            child: p2BirthYearSelectionWidget
          ),

          BigButton(
            text: 'CALCULATE',
            onTap: (){
              print('p1BirthYearSelectionWidget.gender = ${p1BirthYearSelectionWidget.gender}');
              print('p2BirthYearSelectionWidget.gender = ${p2BirthYearSelectionWidget.gender}');
              Navigator.push(context, MaterialPageRoute(

                  builder: (BuildContext context) => E6_CoupleMatchResult(
                    p1BirthYear: p1BirthYearSelectionWidget.birthYear.round(),
                    p1Gender: p1BirthYearSelectionWidget.gender,
                    p2BirthYear: p2BirthYearSelectionWidget.birthYear.round(),
