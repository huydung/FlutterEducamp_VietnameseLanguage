...
class E6_CoupleMatchResult extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AstrologyResult zodiacResult = Astrology.instance.getZodiacResult(p1BirthYear, p2BirthYear);
    AstrologyResult cungMenhResult = Astrology.instance.getCungMenhResult(p1BirthYear, p1Gender, p2BirthYear, p2Gender);
