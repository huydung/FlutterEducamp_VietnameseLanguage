...
class PageTonals extends StatefulWidget {
  PageTonals({Key key, this.title}) : super(key: key);
  final String title;

  @override
  PageTonalState createState() => PageTonalState();
}
...
class PageTonalState extends State<PageTonals> {
