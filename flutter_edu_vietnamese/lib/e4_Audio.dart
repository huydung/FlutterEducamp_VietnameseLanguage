...
class E4_TonalsPage extends StatefulWidget {
  E4_TonalsPage({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _E4_TonalsPageState createState() => _E4_TonalsPageState();
}
...
class _E4_TonalsPageState extends State<E4_TonalsPage> {
